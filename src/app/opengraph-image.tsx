...
const MARK_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none" stroke="#e6cd86" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="24" cy="8.5" r="1.7" fill="#e6cd86" stroke="none"/><path d="M24 8.5V40"/><path d="M8 12H40"/><path d="M8 12 4 20M8 12 12 20"/><path d="M4 20q4 5.5 8 0"/><path d="M40 12 36 20M40 12 44 20"/><path d="M36 20q4 5.5 8 0"/><path d="M24 40 19 43M24 40 29 43M16 43h16"/></svg>`;
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '22px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: '16px' }}>
          ...
          <span style={{ fontSize: '36px', color: '#e6cd86' }}>ميزان</span>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        >
          ...
          <span style={{ display: 'flex', color: '#e6cd86' }}>&bull;</span>
          <span style={{ display: 'flex' }}>No human approval, no finding</span>
        </div>
        <div style={{ display: 'flex', fontSize: '22px', color: '#e6cd86' }}>
